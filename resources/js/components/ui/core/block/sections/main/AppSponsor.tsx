...
<CardHeader className=' max-w-md m-auto p-0'>
    ...
    <CardTitle>
        <h1 className=' tracking-tighter  text-xl md:text-2xl font-extrabold '>
            Download the tastiest app out there
        </h1>
    </CardTitle>
    <CardDescription className='  font-medium md:text-base  text-xs'>Explore our range, get exclusive discounts & order faster than ever!</CardDescription>
</CardHeader>
