...
import { SkeletonCard } from '../../../fragments/custom-ui/card/CardSkeletons';
  ...
  return (
    ...
    <header className='  px-4    flex-row flex justify-between items-end'>
      <h1 className=' pr-3 text-2xl md:text-3xl lg:items-center  flex-col gap-1 lg:gap-1 flex lg:flex-row  font-bold'>
        ...
        <Badge size={"lg"} className=' ml-3 bg-primary text-primary-foreground  font-bold  rounded-xl dark:text-white   scale-110 -rotate-2 lg:-rotate-6  md:text-xl' >
         {props.label}
        </Badge>
        )}
      </h1>
